 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Hi;Hi="",Ri(new Kr("platform-logger",(e=>new Ei(e)),"PRIVATE")),Ri(new Kr("heartbeat",(e=>new ji(e)),"PRIVATE")),Di("@firebase/app","0.9.1",Hi),Di("@firebase/app","0.9.1","esm2017"),Di("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ms(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Fs(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Bs(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Vs(t))return"Blackberry";if(Hs(t))return"Webos";if(xs(t))return"Safari";if((t.includes("chrome/")||js(t))&&!t.includes("edge/"))return"Chrome";if($s(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Bs(e=Nr()){return/firefox\//i.test(e)}function xs(e=Nr()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function js(e=Nr()){return/crios\//i.test(e)}function Fs(e=Nr()){return/iemobile/i.test(e)}function $s(e=Nr()){return/android/i.test(e)}function Vs(e=Nr()){return/blackberry/i.test(e)}function Hs(e=Nr()){return/webos/i.test(e)}function zs(e=Nr()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function qs(){return Pr()&&10===document.documentMode}function Ws(e=Nr()){return zs(e)||$s(e)||Hs(e)||Vs(e)||/windows phone/i.test(e)||Fs(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class co{static parseLink(e){const t=function(e){const t=Vr(Hr(e)).link,n=t?Vr(Hr(t)).deep_link_id:null,r=Vr(Hr(e)).deep_link_id;return(r?Vr(Hr(r)).link:null)||r||n||t||e}(e);try{return new co(t)}catch(e){return null}}constructor(e){var t,n,r,i,s,o;const a=Vr(Hr(e)),c=null!==(t=a.apiKey)&&void 0!==t?t:null,u=null!==(n=a.oobCode)&&void 0!==n?n:null,l=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(r=a.mode)&&void 0!==r?r:null);ts(c&&u&&l,"argument-error"),this.apiKey=c,this.operation=l,this.code=u,this.continueUrl=null!==(i=a.continueUrl)&&void 0!==i?i:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Vo("rcb"),new ls(3e4,6e4);async function Ho(e,t,n){var r;const i=await n.verify();try{let s;if(ts("string"==typeof i,e,"argument-error"),ts("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){ts("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class zo{verifyPhoneNumber(e,t){return Ho(this.auth,e,Jr(t))}static credential(e,t){return ao._fromVerification(e,t)}static credentialFromResult(e){const t=e;return zo.credentialFromTaggedObject(t)}static credentialFromError(e){return zo.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{phoneNumber:t,temporaryProof:n}=e;return t&&n?ao._fromTokenResponse(t,n):null}constructor(e){this.providerId=zo.PROVIDER_ID,this.auth=Xs(e)}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa=new ls(3e4,6e4);function pa(){const e=Lo().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ga=null;function ma(e){return ga=ga||function(e){return new Promise(((t,n)=>{var r,i,s;function o(){pa(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{pa(),n(Yi(e,"network-request-failed"))},timeout:fa.get()})}if(null===(i=null===(r=Lo().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Lo().gapi)||void 0===s?void 0:s.load)){const t=Vo("iframefcb");return Lo()[t]=()=>{gapi.load?o():n(Yi(e,"network-request-failed"))},$o(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw ga=null,e}))}(e),ga}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
